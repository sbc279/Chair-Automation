...
brightness_AltNormIntensityLed = 3000 # Between 0 - 10000 (usually white-colored LED's. Very bright)
...
sw_Main_Dn	= Pin(6,  Pin.IN, pull = Pin.PULL_DOWN)   # Main switch, bank 1 DOWN,   internal pull-down resistor
